...
/PATH/TO/REPO/api
\end{verbatim}
\noindent Here, \verb^??^ refers to the specific release of the NCBI toolkit and may be one of %28, 29, or 30
...
%\noindent {\bf NOTE:  Access to the AACE SVN repository is subject to access permissions.  As such, the User Manual may not reflect where the code for HPC-BLAST may be found for general users.}
...
\noindent {\bf NOTE:  The following directions are for versions 2.2.29-31.}\\
