...
% \begin{figure}[!htbp]
% \centering
% \includegraphics[scale=0.4]{./Images/mpi_model_4.eps}
...
\begin{figure}
  \centering
    \subfloat[The MPI layer.]{ \includegraphics[height=3in]{./Images/mpi_model_4.eps} \label{fig:mpi} }
    \qquad
    \subfloat[The thread layer.]{ \includegraphics[height=3in]{./Images/thread_model.eps} \label{fig:thread} }
